   ...
   * __stop__ OpenStack components (from a previous *stack* start)
   ...
   Note that some of these files are templates (ones ending with *.tpl* are templates). 
   ...
   Thus this templating scheme is useful to accommodate this functionality.
   ...
   **!Installing in a dedicated, disposable vm is safer than installing on your dev machine!**
   ...
   An example of this end state is the following (or similar):
