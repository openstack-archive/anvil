...
class InstallAction(action.Action):
    ...
    def _run(self, persona, component_order, instances):
        ...
        dependency_handler = dependency_handler_class(self.distro,
                                                      ...
                                                      instances.values(),
                                                      self.cli_opts)
        removals = list(states.ACTIONS["pre-install"])
        self._run_phase(
        ...
        removals.extend(states.ACTIONS["package-install"])
        ...
        removals.extend(states.ACTIONS["configure"])
        self._run_phase(
            action.PhaseFunctors(
        ...
        removals.extend(states.ACTIONS["post-install"])
        self._run_phase(
            action.PhaseFunctors(
