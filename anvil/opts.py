...
def parse(previous_settings=None):
    ...
    base_group.add_option("-o", "--source",
                          action="store",
                          type="string",
                          dest="source_fn",
                          default=sh.joinpths(settings.SOURCE_DIR, 'master.yaml'),
                          metavar="FILE",
                          help="source yaml file to apply (default: %default)")
    ...
    values['source_fn'] = options.source_fn
