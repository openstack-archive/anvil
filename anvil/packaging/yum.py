    ...
    def build_binary(self):
        ...
        def pre_build():
            ...
            for repo_name in self.REPOS:
                ...
                basenames = [sh.basename(p) for p in paths]
                envra_details = self.envra_helper.explode(*basenames)
                for (basename, path, envra_detail) in zip(basenames, paths, envra_details):
