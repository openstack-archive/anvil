...
class DependencyHandler(object):
    ...
    def prepare(self):
        ...
        self.gather_pips_to_install(requires_files)
    ...
    def gather_pips_to_install(self, requires_files):
        """Analyze requires_files.
        ...
        cmdline = cmdline + ["-r"] + requires_files
        ...
        utils.log_iterable(self.pips_to_install,
                           logger=LOG,
    ...
    def download_dependencies(self, ignore_installed=True):
...
class EmptyPackager(component.Component):
    def package(self):
        return None
