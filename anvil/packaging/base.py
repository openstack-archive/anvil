...
class DependencyHandler(object):
    ...
    def _try_download_dependencies(self, attempt, pips_to_download,
                                   ...
                                   pip_cache_dir,
                                   pip_build_dir):
        with utils.progress_bar(name='Downloading',
                                max_am=len(pips_to_download)) as p_bar:
            for (i, p) in enumerate(pips_to_download):
                cmdline = [
                    self.pip_executable,
                    "install",
                ...
                download_filename = "pip-download-attempt-%s-%s.out"
                download_filename = download_filename % (attempt, p.key)
