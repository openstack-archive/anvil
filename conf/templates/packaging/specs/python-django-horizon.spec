...
%config%configfile %{_sysconfdir}/httpd/conf.d/openstack-dashboard.conf
%config%configfile %attr(0640, root, apache) %{_sysconfdir}/openstack-dashboard/local_settings
%endif
