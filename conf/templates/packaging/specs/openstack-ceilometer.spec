...
%config%configfile %attr(-, root, ceilometer) %{_sysconfdir}/ceilometer/ceilometer.conf
%config%configfile %attr(-, root, ceilometer) %{_sysconfdir}/ceilometer/policy.json
%config%configfile %attr(-, root, ceilometer) %{_sysconfdir}/ceilometer/sources.json
%config%configfile %attr(-, root, ceilometer) %{_sysconfdir}/ceilometer/pipeline.yaml
#else
%config%configfile %attr(-, root, ceilometer) %{_sysconfdir}/ceilometer/*
#end if

%config%configfile %{_sysconfdir}/logrotate.d/%{name}
...
#if $newer_than_eq('2014.2')
%files ipmi
%config%configfile %attr(-, root, ceilometer) %{_sysconfdir}/ceilometer/rootwrap.d/ipmi.filters
