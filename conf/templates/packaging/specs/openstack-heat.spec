...
# install init files
install -p -D -m 644 %{SOURCE10} %{buildroot}%{_initrddir}/openstack-heat-api.init
install -p -D -m 644 %{SOURCE11} %{buildroot}%{_initrddir}/openstack-heat-api-cfn.init
install -p -D -m 644 %{SOURCE12} %{buildroot}%{_initrddir}/openstack-heat-engine.init
install -p -D -m 644 %{SOURCE13} %{buildroot}%{_initrddir}/openstack-heat-api-cloudwatch.init
...
%{_bindir}/heat-engine
%{_initrddir}/openstack-heat-engine.init
...
%doc README.rst LICENSE
%{_bindir}/heat-api
%{_initrddir}/openstack-heat-api.init
...
%{_initrddir}/openstack-heat-api-cfn.init
...
%{_initrddir}/openstack-heat-api-cloudwatch.init
