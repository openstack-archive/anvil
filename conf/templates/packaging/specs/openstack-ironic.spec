...
%config%configfile %{_sharedstatedir}/ironic/pxe_config.template
%dir %attr(0755, ironic, ironic) %{_localstatedir}/log/ironic
%dir %attr(0755, ironic, ironic) %{_localstatedir}/run/ironic

%config%configfile %attr(-,root,ironic) %{_sysconfdir}/ironic
%config%configfile %attr(0640, root, ironic) %{_sysconfdir}/ironic/policy.json
%config%configfile %attr(0640, root, ironic) %{_sysconfdir}/ironic/ironic.conf

%config%configfile %{_sysconfdir}/ironic/rootwrap.conf
%config%configfile %{_sysconfdir}/ironic/rootwrap.d/*
%config%configfile %{_sysconfdir}/logrotate.d/*
%config%configfile %{_sysconfdir}/sudoers.d/ironic
