...
%config%configfile %attr(-, root, cinder) %{_sysconfdir}/cinder/*
%config%configfile %{_sysconfdir}/logrotate.d/openstack-cinder
%config%configfile %{_sysconfdir}/sudoers.d/cinder
%config%configfile %{_sysconfdir}/tgt/conf.d/cinder.conf
