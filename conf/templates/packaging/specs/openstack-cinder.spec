...
install -p -D -m 644 %{SOURCE10} %{buildroot}%{_initrddir}/%{daemon_prefix}-api
install -p -D -m 644 %{SOURCE11} %{buildroot}%{_initrddir}/%{daemon_prefix}-scheduler
install -p -D -m 644 %{SOURCE12} %{buildroot}%{_initrddir}/%{daemon_prefix}-volume
