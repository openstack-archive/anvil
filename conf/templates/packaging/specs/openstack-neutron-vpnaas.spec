...
%if ! 0%{?usr_only}
%config%configfile %attr(0640, root, neutron) %{_sysconfdir}/neutron/vpn_agent.ini
%config%configfile %attr(0640, root, neutron) %{_sysconfdir}/neutron/neutron_vpnaas.conf
